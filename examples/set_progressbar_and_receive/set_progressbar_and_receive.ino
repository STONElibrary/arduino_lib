 ...
 *  GUI:https://github.com/STONElibrary/stone_serial/blob/v1.0.9/Example/Arduino%26ESP32/set_progressbar_and_receive/Linear_amplifier_1.st
 */
  ...
  while (receive_over_flage >= 1)
    {
      ...
      receive_parse(user_link->base_offset);
